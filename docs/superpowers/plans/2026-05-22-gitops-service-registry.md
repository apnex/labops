...
## install Argo CD (stable channel) — server-side apply: the ApplicationSet CRD
## exceeds client-side apply's 262144-byte last-applied-configuration annotation limit
